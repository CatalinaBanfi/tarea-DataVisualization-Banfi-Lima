...
ggplot_map <- ggplot_map + scale_fill_distiller(palette = "YlOrBr") #Agregamos la escala de colores
...
ggplot_map <- ggplot_map + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank()) #Eliminamos la grilla y el color de fondo.
